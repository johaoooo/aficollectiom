...
import {
  ...
  Bag, TShirt, Couch, Armchair,
  CaretDown, CaretUp, ArrowRight
    ...
    <section className="py-20 bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          >
            <span className="inline-block px-4 py-1.5 rounded-full text-xs font-semibold tracking-wider
              bg-[#008753]/10 text-[#008753] dark:bg-[#008753]/20 dark:text-[#2ECC85] mb-4">
              SAVOIR-FAIRE
            </span>
            ...
            <p className="text-gray-500 dark:text-gray-400 max-w-md mx-auto">
              Quatre filières artisanales et agroalimentaires
            </p>
          </motion.div>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                            ...
                            {category.subItems.map((item, idx) => (
                              <Link
                                ...
                                className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400
                                  hover:text-[#008753] dark:hover:text-[#2ECC85]
                  ...
                  <div 
                    className="absolute inset-x-0 bottom-0 h-1 rounded-b-2xl transition-all duration-300"
                    style={{ 
        ...
        {/* Lien Voir toutes les formations */}
        <motion.div
          initial={{ opacity: 0 }}
