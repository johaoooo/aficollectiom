...
export default function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div className="mx-3 sm:mx-6 mt-3">
          <div
            ...
            `}
          >
            <div className="max-w-[1180px] mx-auto px-4 sm:px-6 flex items-center justify-between h-[62px]">
                ...
                {links.map(({ label, href, icon: Icon }) => {
                  ...
                  return (
                    <Link
                      ...
                      className={`
                        relative flex items-center gap-[7px] px-3.5 py-2 rounded-xl
              ...
              <div className="hidden lg:flex items-center gap-2">
                <DarkModeToggle />
                <div className="w-px h-4 bg-gradient-to-b from-transparent via-gray-300 dark:via-white/20 to-transparent mx-0.5" />
                <Link
                  to="/connexion"
                  className="flex items-center gap-2 px-4 py-2 rounded-xl text-[13px] font-[500] text-gray-600 dark:text-gray-300 hover:bg-black/[.05] dark:hover:bg-white/[.07] hover:text-gray-900 dark:hover:text-white transition-all duration-200"
                >
                        ...
                        >
                          ...
                          >
                            <Icon
                              weight={active ? 'fill' : 'regular'}
                              size={17}
                              className={active ? 'text-[#008753] dark:text-[#2ECC85]' : 'text-gray-400 dark:text-gray-500'}
                            />
                            {label}
                          </Link>
                        </motion.div>
      ...
      {/* Spacer pour que le contenu ne soit pas caché sous la navbar flottante */}
